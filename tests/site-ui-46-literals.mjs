...
import { beforeUi47Literals } from "./site-ui-47-literals.mjs";
...
export function beforeUi46Literals(file, input) {
  let result = beforeUi47Literals(file, input);
...
export function assertUi46Literals(root) {
  ...
  for (const [file, edits] of Object.entries(uiLiterals46.edits)) {
    ...
    const current = beforeUi47Literals(file, fs.readFileSync(path.join(root, file), "utf8"));
